...
def test_model_results():
    ...
    for line in lines:
        ...
        yaw, pitch, roll = h5_crop_and_pred(root+filename, bbox, model)
        print("__________________________________________________________________________________________________")
        yaw_k2o, pitch_k2o, roll_k2o = onnx_crop_and_pred(root+filename, bbox, sess, file_name, model.idx_tensor_yaw, model.idx_tensor)
        ...
        print("__________________________________________________________________________________________________")
        yaw_tf2o, pitch_tf2o, roll_tf2o = onnx_crop_and_pred(root+filename, bbox, sess, file_name_tf, model.idx_tensor_yaw, model.idx_tensor)
